...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__30550_SHARP_){
return (((p1__30550_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__30550_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__30551,new cljs.core.Keyword(null,"class","class",-2030961996),daiquiri.normalize.normalize_class);
} else {
return G__30551;
}
});
...
var len__4736__auto___30574 = arguments.length;
var i__4737__auto___30575 = (0);
while(true){
if((i__4737__auto___30575 < len__4736__auto___30574)){
args__4742__auto__.push((arguments[i__4737__auto___30575]));

var G__30579 = (i__4737__auto___30575 + (1));
i__4737__auto___30575 = G__30579;
continue;
} else {
}
break;
...
var G__30553 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30553,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__30553;
}
} else {
...
/** @this {Function} */
(daiquiri.normalize.merge_with_class.cljs$lang$applyTo = (function (seq30552){
...
var vec__30556 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():((cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null),cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30556,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30556,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,daiquiri.normalize.strip_css(cljs.core.some((function (p1__30554_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__30554_SHARP_))){
return p1__30554_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$1((function (p1__30555_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__30555_SHARP_))){
return daiquiri.normalize.strip_css(p1__30555_SHARP_);
} else {
return null;
}
})),names)], null);
 ...
 */
daiquiri.normalize.element = (function daiquiri$normalize$element(p__30563){
...
var tag = first__30566;
var content = seq__30565__$1;
...
var vec__30570 = daiquiri.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30570,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30570,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30570,(2),null);
var tag_attrs = (function (){var G__30573 = cljs.core.PersistentArrayMap.EMPTY;
var G__30573__$1 = (((!(cljs.core.empty_QMARK_(id))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30573,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__30573);
if((!(cljs.core.empty_QMARK_(class$)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30573__$1,new cljs.core.Keyword(null,"class","class",-2030961996),class$);
} else {
return G__30573__$1;
}
})();
